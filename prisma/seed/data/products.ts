export default function getProducts(){
    const products = [
        ...
        },
        {
            ...
            price: 200000,
            image_url: "full-size-blender.jpg",
            category_id: "kitchen",
